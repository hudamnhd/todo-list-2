    ...
    if (active_task) {
      ...
      if (!timerRef.current) {
        timerRef.current = setInterval(() => {
          const elapsedTime = last_session.elapsed_time
  ...
  const test = [
    {
      id: 1,
      log: [
        { time: 1733770148301, name: "start" },
        {
          time:
            1733770148301 +
            (Math.random() * (25 * 60 * 1000 - 20 * 60 * 1000) +
              20 * 60 * 1000),
          name: "done",
        },
      ],
    },
    {
      id: 2,
      log: [
        { time: 1733770220599, name: "start" },
        {
          time:
            1733770220599 +
            (Math.random() * (15 * 60 * 1000 - 10 * 60 * 1000) +
              10 * 60 * 1000),
          name: "pause",
        },
        {
